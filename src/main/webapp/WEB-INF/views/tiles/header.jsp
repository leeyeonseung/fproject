	...
	<header class="top-bar">
		...
		<ul class="profile">
			...
			<li class="profile--higlighted1"><span
				...
				<ul class="dropdown-menu pull-right">
					<li><a style="color: white;">
						<button style="background: #333" type="button" data-toggle="modal" data-target="#exampleModalLong">메시지 작성하기💌</button></a></li>
					<li><a href="/msg/msgAllList"><i class="icon pe-7s-mail"></i>메세지함</a></li>
				</ul>
			</li>
			...
			<li class="profile--higlighted">
				...
				<ul class="dropdown-menu pull-right">
					<li><a href="/vote/votemake"><i class="icon pe-7s-drawer"></i>투표 만들기 & 투표함</a></li>
				</ul>
			</li>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					수신자 : 
					<input type="text" id="word" name="re_usid" placeholder="검색어를 입력하세요." autocomplete="off" onkeyup="search(this);">
					<ul id="schoolList" >
