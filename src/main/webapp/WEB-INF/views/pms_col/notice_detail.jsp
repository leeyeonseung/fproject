			...
			<div class="col-md-12">
				<article class="widget">
					<header class="widget__header">
						<h3 class="widget__title" >${notice.noticesj }</h3>
					...
					<c:choose>
						<c:when test="${author eq 1 }">
							<button type="button"  style="display: block;" id="modifyBtn">수정하기</button>
							<button type="button"  style="display: block;" id="deleteBtn" >삭제</button>
